...
x=np.array(result_df['h1'])
y=np.array(result_df['l1']/0.613)

x1=np.array(result_df1['h1'])
y1=np.array(result_df1['l1']/0.390)

x2=np.array(result_df2['h1'])
y2=np.array(result_df2['l1']/0.542)

x3=np.array(result_df3['h1'])
y3=np.array(result_df3['l1']/0.367)

x4=np.array(result_df4['h1'])
y4=np.array(result_df4['l1']/0.574)

x5=np.array(result_df5['h1'])
y5=np.array(result_df5['l1']/0.306)
...
# 保存到 CSV 文件
# df_combined.to_csv('combined_summarymid11301230.csv', index=False)
...
ax1.set_xlim([2,8])
# 添加 x 轴标签
ax1.set_xlabel('车队间平均车头时距',fontproperties=font_prop)
...
# 移动次坐标轴的左侧轴线到下方
ax2.set_xlabel('车队间平均车头时距',fontproperties=font_prop)
...
output_path1 = f"{'/Users/pjl/Desktop/中国公路学报'}/{'intra567.png'}"
# 保存图表为高质量图片
fig1.savefig(output_path1, dpi=600, bbox_inches='tight')
output_path2 = f"{'/Users/pjl/Desktop/中国公路学报'}/{'intra234.png'}"
# 保存图表为高质量图片
fig2.savefig(output_path2, dpi=600, bbox_inches='tight')


# output_path1 = f"{'/Users/pjl/Desktop/research_KUL/0229'}/{'mid1ff.png'}"
# # 保存图表为高质量图片
# fig1.savefig(output_path1, dpi=300, bbox_inches='tight')
# output_path2 = f"{'/Users/pjl/Desktop/research_KUL/0229'}/{'mid1cong.png'}"
# # 保存图表为高质量图片
...
# sns.histplot(p2_samples, kde=True, stat="density", bins=30, label='Z6')
...
# plt.xlabel('H')
# plt.ylabel('Density')
# output_path2 = f"{'/Users/pjl/Desktop/research_KUL/paper_platoon/elsarticle-template'}/{'fig12_1112H.png'}"
# # 保存图表为高质量图片
...
# 绘制数据点
# 绘制第一个置信区间
# ax1.plot(x_vis, mean, 'red', label='Estimated_z7')
# lower_bound = mean - 1.96 * std_dev
# upper_bound = mean + 1.96 * std_dev
# LCM=upper_bound*x_vis
# Q=3600/x_vis
# plt.plot(Q,LCM)
# plt.show()
# ax1.plot(x_vis, lower_bound, '--', color='gray')
# ax1.plot(x_vis, upper_bound*x_vis, '--', color='red', label='Estimated_z7')


# # 绘制第二个置信区间
# # ax1.plot(x_vis, mean_z6, 'blue', label='Estimated_z6')
# lower_bound_z6 = mean_z6 - 1.96 * std_dev_z6
# upper_bound_z6 = mean_z6 + 1.96 * std_dev_z6
# # ax1.plot(x_vis, lower_bound_z6, '--', color='gray')
# ax1.plot(x_vis, upper_bound_z6*x_vis, '--', color='blue', label='Estimated_z6')
#
# # ax1.plot(x_vis, mean_z5, 'yellow', label='Estimated_z5')
# lower_bound_z5 = mean_z5 - 1.96 * std_dev_z5
# upper_bound_z5 = mean_z5 + 1.96 * std_dev_z5
# # ax1.plot(x_vis, lower_bound_z5, '--', color='gray')
# ax1.plot(x_vis, upper_bound_z5*x_vis, '--', color='yellow', label='Estimated_z5')
#
# ax1.set_ylabel('Free flow LCM (1/km)')
# # ax1.set_xlim([2,8])
#
# # 添加 x 轴标签
# ax1.set_xlabel('Average inter-platoon headway (s)')
...
#
# # 绘制更多置信区间
# # ax2.plot(x_vis, p11_z4*(p3_z4-x_vis)**p12_z4, 'green', label='Estimated_z4')
# lower_bound_z4 = mean_z4 - 1.96 * std_dev_z4
# upper_bound_z4 = mean_z4 + 1.96 * std_dev_z4
# # ax2.plot(x_vis, lower_bound_z4, '--', color='gray')
# ax2.plot(x_vis, upper_bound_z4*x_vis, '--', color='green', label='Estimated_z4')
#
# # ax2.plot(x_vis, p11_z3*(p3_z3-x_vis)**p12_z3, 'pink', label='Estimated_z3')
# lower_bound_z3 = mean_z3 - 1.96 * std_dev_z3
# upper_bound_z3 = mean_z3 + 1.96 * std_dev_z3
# # ax2.plot(x_vis, lower_bound_z3, '--', color='gray')
# ax2.plot(x_vis, upper_bound_z3*x_vis, '--', color='pink', label='Estimated_z3')
#
# # ax2.plot(x_vis, p11_z2*(p3_z2-x_vis)**p12_z2, 'black', label='Estimated_z2')
# lower_bound_z2 = mean_z2 - 1.96 * std_dev_z2
# upper_bound_z2 = mean_z2 + 1.96 * std_dev_z2
# # ax2.plot(x_vis, lower_bound_z2, '--', color='gray')
# ax2.plot(x_vis, upper_bound_z2*x_vis, '--', color='black', label='Estimated_z2')
#
# ax2.set_ylabel('Congestion and transition LCM (1/km)')
# # 移动次坐标轴的左侧轴线到下方
# ax2.set_xlabel('Average inter-platoon headway (s)')
# ax2.set_xlim([2,8])
...
# output_path2 = f"{'/Users/pjl/Desktop/中国公路学报'}/{'fig车队间H.png'}"
# # 保存图表为高质量图片
